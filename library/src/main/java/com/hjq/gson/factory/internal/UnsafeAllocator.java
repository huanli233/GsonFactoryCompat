...
package com.hjq.gson.factory.internal;
...
public abstract class UnsafeAllocator {
  ...
  public static UnsafeAllocator create() {
    ...
    try {
      ...
      @SuppressLint("DiscouragedPrivateApi") Field f = unsafeClass.getDeclaredField("theUnsafe");
    ...
    // }
    try {
      @SuppressLint("DiscouragedPrivateApi") Method getConstructorId =
